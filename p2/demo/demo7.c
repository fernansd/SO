...
int main(void)
{
   ...
   /*Este join() no será bloqueante al ser la hebra detach, por lo que si se ejecuta una vez haya terminado
     la hebra obtendremos el valor devuelto 10, si se ejecuta antes de que termine la hebra el valor que obtendremos en ret sera el de 7 */
