...
for(t=0;t<NUM_THREADS;t++) {
  ...
  Con el sleep(3) comentado, posiblemente las hebras impriman todas que su tarea es la 8, ya que al proceso principal le dará
	tiempo a crear todas las hebras antes de que una de ellas empiece a ejecutar. En este caso, todas recogeran un valor de "t" igual a 8.*/
  //sleep(3);   
  if (rc) {
